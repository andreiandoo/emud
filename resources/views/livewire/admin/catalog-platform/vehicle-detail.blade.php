<div class="space-y-6">
    <div>
        ...
        <h1 class="mt-2 text-2xl font-semibold tracking-tight">{{ $vehicle->generation?->model?->make?->name }} {{ $vehicle->generation?->model?->name }} {{ $vehicle->generation?->name }}</h1>
